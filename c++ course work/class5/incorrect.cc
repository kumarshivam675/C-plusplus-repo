...
main()
{
	...
	Ticket *ticket1 = new Ticket(train1,"Bangalore City","Salem");

	ticket1->addPassenger("John","25","M","S1","25");
	ticket1->addPassenger("Jane","45","F","S2","26");
	ticket1->addPassenger("Joe","35","M","S1","33");
		
	Ticket *ticket2 = new Ticket(train1,"Bangalore City","Chennai");
	...
	Ticket *ticket3 = new Ticket(train2,"Bangalore City","Nagpur");
